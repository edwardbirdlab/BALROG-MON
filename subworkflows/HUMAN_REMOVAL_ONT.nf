...
include { SAMTOOLS_EXTRACT_UNMAPPED_ONT as SAMTOOLS_EXTRACT_UNMAPPED_HUMAN } from '../modules/SAMTOOLS_EXTRACT_UNMAPPED_ONT.nf'
...
workflow HUMAN_REMOVAL_ONT {
    ...
    main:
        ...
        SAMTOOLS_EXTRACT_UNMAPPED_HUMAN(MINIMAP2_ONT_HUMAN.out.sam)
        ...
        FASTQC_HUMAN_DEP(SAMTOOLS_EXTRACT_UNMAPPED_HUMAN.out.non_host_reads)


    emit:
        human_depleted_reads    =  SAMTOOLS_EXTRACT_UNMAPPED_HUMAN.out.non_host_reads  //   channel: [ val(sample), fastq]
